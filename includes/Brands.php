	...
	public static function get_brands(): array {
		...
		return array(
			...
			'vodien'         => array(
				...
				'facebookUrl'                 => apply_filters( 'nfd_build_url', 'https://www.facebook.com/Vodien/' ),
				'twitterName'                 => '@vodien',
				...
				'accountUrl'                  => apply_filters( 'nfd_build_url', 'https://www.vodien.com/my-account' ),
				...
				'hireExpertsInfo'             => array(
					'defaultLink'   => apply_filters( 'nfd_build_url', 'https://www.vodien.com/digital-marketing-services' ),
					'utmParameters' => array(
						'utm_source'   => '',
						'utm_medium'   => '',
						'utm_campaign' => '',
				...
				'fullServiceCreativeTeamInfo' => array(
					'defaultLink' => apply_filters(
						'nfd_build_url',
						'https://www.vodien.com/digital-marketing-services',
						array(
							'utm_source' => 'wp-onboarding',
						)
					),
